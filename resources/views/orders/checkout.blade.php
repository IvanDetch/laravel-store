                    ...
                    <form class="card-body" action="{{ route('order.store') }}" method="POST">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" id="phone" class="form-control" placeholder="+1 (123) 456-7890"
                                   name="customerPhone" value="{{ auth()->user()->phone ?? null }}" required>
                        </div>

                        <div class="form-group mb-5">
                            <label for="address" class="">Address</label>
                            <input type="text" id="address" class="form-control" placeholder="Park av., 123, New York, USA"
                                   name="customerAddress" value="{{ auth()->user()->address ?? null }}" required>
                        </div>

                        <div class="form-group mb-5">
                            <label for="comment" class="">Comment</label>
                            <textarea type="text" id="comment" class="form-control" placeholder="Comment"
